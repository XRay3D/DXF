...
CodeData::Type CodeData::type() const { return static_cast<Type>(m_val.index()); }

QVariant CodeData::value() const
{
    QVariant variant;
    std::visit([&variant](auto&& arg) { variant = arg; }, m_val);
    return variant;
}
