...
void SPLINE::parse(CodeData& code)
{
    ...
    do {
        ...
        case SubclassMarker: //100
            break;
        case NormalVectorX: //210
            break;
        case NormalVectorY: //220
            break;
        case NormalVectorZ: //230
            break;
        case SplineFlag: //70
            splineFlag = code;
            break;
    ...
    qDebug() << '\t' << KnotValues.size() << KnotValues;
    qDebug() << '\t' << ControlPoints.size() << ControlPoints;
    qDebug() << '\t' << FitPoints.size() << FitPoints;
}
