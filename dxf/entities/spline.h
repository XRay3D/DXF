...
public:
    ...
    enum VarType {
        ...
        NormalVectorX = 210, //	210	Вектор нормали (отсутствует, если сплайн неплоский)
        NormalVectorY = 220, //        Dxf: x value; App: 3dVector		=		,//		Файл DXF: значение X; приложение: 3D-вектор
        NormalVectorZ = 230, //        Dxf: y and z valuesOfNormalVector (optional)		=	220, 230	,//	220, 230	Файл DXF: значение Y и Z вектора нормали (необязательно)
